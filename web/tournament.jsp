<%-- 
    Document   : tournament
    Created on : Feb 19, 2023, 5:13:23 PM
    Author     : Admin
--%>
    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class=" container tnm-categories-heading">
                <a href=""><p> All Tournaments<i class='fas fa-award' style='font-size:24px;color: #dbbd0e;;'></i></p></a>
                <a href=""><p>On-Going Tournaments</p></a>
                <a href=""><p>Old Tournament</p></a>
                <a href=""><p>Delay Tournament<i class='fas fa-hourglass-end' style='font-size:24px;color: green;'></i></p></a>
            </div>
            <!-- tnm-list -->
                ...
                <div class="tnm-list container">
                    ...
                    <div class="tnm-card-site-ptr">
                        <div class="card" style="width: 45rem;">
                            <img class="card-img-top" style="height: 30rem;" src="https://saigongiaitri.net/uploads/news/2018_04/ben-hen-2018-0.jpg" alt="Card image cap">
                    ...
                    <!-- Car 3 -->
                    <div class="tnm-card-site-ptr">
                        <div class="card card-tnm" style="width: 45rem;">
                            <img class="card-img-top" style="height: 30rem;" src="https://saigongiaitri.net/uploads/news/2018_04/ben-hen-2018-0.jpg" alt="Card image cap">
                            <div class="card-body" style="height:20rem;">
                                <!-- status -->
                                <div class="status-heading d-flex justify-content-center" style="font-weight: bold;">
