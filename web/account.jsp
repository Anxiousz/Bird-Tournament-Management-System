                    ...
                    <div class="private-inf-account">
                        ...
                        <div class="form-inf-account">
                            ...
                            <div class="btn-update-acc">
                                <button class="btn btn-danger btn-close"><p>Close</p></button>
                                <button class="btn btn-update btn-success "><p>Update</p></button>
                            </div>
                        </div>   
                </form>
            </div>
